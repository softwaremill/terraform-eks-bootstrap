...
| <a name="input_eks_cluster_additional_node_groups"></a> [eks\_cluster\_additional\_node\_groups](#input\_eks\_cluster\_additional\_node\_groups) | EKS managed additional node group | `any` | `{}` | no |
