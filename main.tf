...
module "eks" {
  ...
  eks_managed_node_group_defaults = var.eks_single_az ? merge(var.eks_cluster_node_groups_default_configuration, { subnet_ids = slice(module.vpc.private_subnets, 0, 1) }) : var.eks_cluster_node_groups_default_configuration
